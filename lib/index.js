...
var Emitter = /** @class */ (function () {
    ...
    Emitter.prototype.emit = function (type, data) {
        ...
        this.emitting = true;
        return new Promise(function (resolve, reject) {
            var redisClient = _this.options.redisClient ||
                (_this.options.redisConnect &&
                    redis.createClient(_this.options.redisConnect));
            // 获取该类型监听类型列表
    ...
    Emitter.prototype.on = function (type, encoding, fn) {
        var _this = this;
        var redisClient = this.options.redisClient ||
